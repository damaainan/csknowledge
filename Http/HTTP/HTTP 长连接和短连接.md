...
来源：[http://www.frostsky.com/2017/02/http-长连接和短连接/](http://www.frostsky.com/2017/02/http-长连接和短连接/)

时间 2017-02-05 14:54:57
...
短连接对于服务器来说管理较为简单，存在的连接都是有用的连接，不需要额外的控制手段。但如果客户 **`请求频繁`**  ， **`将在TCP的建立和关闭操作上浪费时间和带宽。`** 
